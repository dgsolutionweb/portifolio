      ...
      <div className="container mx-auto px-8">
        <div className="flex flex-col items-center">
          ...
          <motion.a
            ...
            className="text-[clamp(1.5rem,4vw,3rem)] text-secondary underline decoration-1 underline-offset-8 transition-colors duration-300 hover:text-primary hover:decoration-primary flex items-center justify-center gap-4"
            initial={{ opacity: 0 }}
