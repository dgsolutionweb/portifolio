  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <footer className="py-8 border-t border-primary/10 bg-background/80">
        <div className="container mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-8 md:gap-0 text-center md:text-left">
          <div className="flex items-center">
            <a href="https://wa.me/5517999754390" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-primary no-underline transition-opacity hover:opacity-80">
              <svg
